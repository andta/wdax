...
define(function(require, exports, module) {
	...
	var outtime = 100000; //超时
	var url = 'http://192.168.1.83/Mobile/AboutInfo'; //loio.wicp.net
	/*
	 * 初始化Mui
	 */
	mui.init({
	...
	var ajax = function() {
		//创建新的Bmob.Object子类
		var db = Bmob.Object.extend("bmob_db_about");
