...
(function(a) {
	...
	d.initialize = function(h, g, f) {
		if (f) {
			throw "Bmob.initialize() was passed a Master Key, which is only allowed from within Node.js."
		}
		d._initialize(h, g, f)
	};
...
(function(b) {
	...
	h.File.prototype = {
		...
		url: function() {
			if (this._url.indexOf(h.fileURL) >= 0) {
				return this._url
			} else {
				return h.fileURL + "/" + this._url
			}
		},
		group: function() {
			return this._group
		...
		destroy: function(i) {
			if (!this._url && !this._group) {
				return h.Promise.error("The file url and group is not eixsts.")._thenRunCallbacks(i)
			}
			var k = {
				group: this._group,
			...
			var j = h._request("files", null, null, "DELETE", k);
			...
			if (!i._previousSave) {
				if (i._source) {
					i._previousSave = i._source.then(function(k, l) {
						...
						return h._request("files", i._name, null, "POST", m)
					}).then(function(k) {
						i._name = k.filename;
						i._url = k.url;
						i._group = k.group;
